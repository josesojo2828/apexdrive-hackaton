...
export const ServicePlanForm: FormStructure = {
    ...
    fields: [
        ...
        { name: 'billingCycle', label: 'plan.billing_cycle', type: 'text', validation: { required: true }, gridCols: 2 },
        {
            name: 'categoryId',
            label: 'plan.category',
            type: 'autocomplete',
            remote: { slug: 'service-category' },
            validation: { required: true }
        },
        { name: 'attributes', label: 'plan.attributes', type: 'textarea' },
        { name: 'order', label: 'plan.order', type: 'number', gridCols: 2 },
        { name: 'isPopular', label: 'plan.is_popular', type: 'switch', gridCols: 2 }
    ]
};
