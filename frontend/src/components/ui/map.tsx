...
const defaultStyles = {
  ...
  hybrid: {
    ...
    sources: {
      labels: {
        type: "raster",
        tiles: ["https://basemaps.cartocdn.com/rastertiles/light_only_labels/{z}/{x}/{y}@2x.png"],
        tileSize: 256,
...
const Map = forwardRef<MapRef, MapProps>(function Map(
  ...
  const resolvedTheme = useResolvedTheme('light');
  ...
  useEffect(() => {
    ...
    const newStyle =
      // resolvedTheme === "hybrid" ? mapStyles.hybrid :
      resolvedTheme === "dark" ? mapStyles.dark : mapStyles.light;
