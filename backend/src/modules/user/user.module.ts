...
// Address
import { AddressCrudController } from "./infrastructure/controllers/address.crud";
...
import { CreateAddressPersistence, UpdateAddressPersistence, DeleteAddressPersistence, FindAddressPersistence } from "./infrastructure/persistence/address/address.persistence";
...
@Module({
    ...
    providers: [
        ...
        // Address
        CreateAddressUCase, UpdateAddressUCase, DeleteAddressUCase, QueryAddressUCase,
        CreateAddressPersistence, UpdateAddressPersistence, DeleteAddressPersistence, FindAddressPersistence,
        ...
        UpdateBusinessProfileUCase, BusinessProfilePersistence,
    ...
    exports: [
        // Exporting services if needed by other modules
        FindUserPersistence,
        FindAddressPersistence,
